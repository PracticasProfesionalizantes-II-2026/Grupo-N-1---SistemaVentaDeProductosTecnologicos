...
- Resultado verificado al 18/09: build Release, 0 errores y 0 advertencias; 8/8 unitarias; 39/39 integraciones rápidas; 14/14 SQL; 4/4 E2E previamente verificadas. La prueba SQL específica del catálogo confirma filtros combinados, conteo, proyección y paginación determinista sobre LocalDB. El job `catalog-e2e` quedó encadenado después de las suites rápida y SQL.
- Cierre Backend 18/09: errores `400` estructurados mediante código y mensaje seguros; texto recortado con máximo de 100 caracteres; límites y páginas vacías cubiertos; cancelación HTTP propagada hasta las operaciones asincrónicas de EF Core.
